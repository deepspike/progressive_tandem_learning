...
from models.cifar10.vgg11 import layer_list, stride_list, VGG11, sVGG11
...
assert os.path.exists(os.path.join(ann_ckp_dir, 'cifar10_vgg11_baseline.pt')), 'The checkpoint for the pre-trained ANN is not available.'
snn_ckp_dir = os.path.join(home_dir, 'exp/cifar10/VGG11/')
...
if __name__ == '__main__':
	...
	print('Accuracy of pre-trained model {}'.format(best_acc_ann))
	...
	dump_json(training_record, snn_ckp_dir, 'spiking_vgg11_train_record')